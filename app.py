...
def welcome():
    ...
    return (
        ...
        f"</tr>"
        f"<tr>"
        f"<td><a href=\"/api/v1.0/precipitation\" />/api/v1.0/precipitation</td>"
        f"<td>Return a json list of precipitation data in Hawaii from 08/23/2016 to 08/23/2017.</td>"
        f"</tr>"
        f"<tr>"
        f"<td><a href=\"/api/v1.0/stations\" />/api/v1.0/stations</td>"
        f"<td>Return a json list of Hawaii weather stations</td>"
        f"</tr>"
        f"<tr>"
		f"<td><a href=\"/api/v1.0/tobs\" />/api/v1.0/tobs</td>"
